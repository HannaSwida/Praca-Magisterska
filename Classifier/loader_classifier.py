...
class VCset(Dataset):
    ...
    def __init__(self, input_dirs_file, rate=16000, chunk_size=0.2, n_batches=100, batch_size=128) -> None:
        super().__init__()
        self.n_labels = None
    ...
    def __getitem__(self, index):
        ...
        # Get the label for the current audio chunk
        label = class_name1  # Extract the numeric part of the class_name1 (speaker ID)
        return c_1, label  # Return the audio chunk and its corresponding label
